...
# program_counter SDC but written with port collections because
# gpu has ~183 ports
###################################################################
set sdc_version 2.1
...
# If preCTS/final setup timing shows negative slack at ss_125, raise the
# period here AND in gpu_postcts.sdc (e.g. to 20) and re-run.
...
# input transition times on every input (clk included, matching the
# course SDC, where clk additionally has the clock transitions above)
